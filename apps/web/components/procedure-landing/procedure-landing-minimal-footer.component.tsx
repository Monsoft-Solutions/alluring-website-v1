 ...
 *
 * Single-strip legal footer for procedure landing pages. Privacy/Terms
 * are the only outbound links — required by Meta and Google ad-policy
 * compliance — and they open in the same tab so abandonment is rare.
 */
import Link from 'next/link'

import { siteConfig } from '@/lib/data/site-config'

export function ProcedureLandingMinimalFooter() {
