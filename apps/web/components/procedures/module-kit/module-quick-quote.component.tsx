 ...
 * a reader has just seen real outcomes, far above the full form on a phone.
 *
 ...
 */
export function ModuleQuickQuote({
    procedureSlug,
    heading,
    className,
}: {
    procedureSlug: string
    /** e.g. "Get your personal BBL plan and price". */
    heading: string
    className?: string
}) {
    return (
        <div className='bg-stone-50'>
            <section
                ...
                className={cn(moduleContainer, 'pb-12 md:pb-24', className)}
            >
