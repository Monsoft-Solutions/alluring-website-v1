 ...
 * BBLHero Component
 *
 * A conversion-focused hero section targeting BBL seekers (25-40):
 * - Emphasizes Miami as THE global destination for BBL
 * - Addresses safety concerns (critical for BBL marketing)
 * - Natural results focus over dramatic transformations
 *
 * Optimized for high-intent Brazilian Butt Lift searches.
 */
import {
    Award,
    ShieldCheck,
...
export function BBLHero({ id = 'hero' }: BBLHeroProps) {
    return (
        <section
            id={id}
            ...
            <div className='relative z-10 flex min-h-screen flex-col lg:flex-row'>
                ...
                <div className='animate-fade-in-up relative w-full lg:w-1/2'>
                    <div className='h-[65vh] p-4 lg:h-full lg:p-20'>
                        <div className='shadow-gold-500/20 relative h-full w-full overflow-hidden rounded-2xl shadow-2xl sm:rounded-none sm:shadow-none'>
                            <Image
                                src='/images/landing/bbl-miami-hero.jpg'
                                alt='Woman with natural curves after Brazilian Butt Lift in Miami'
                                fill
                ...
                <div className='animate-fade-in-up flex w-full flex-col justify-center px-6 py-8 delay-200 md:px-12 lg:w-1/2 lg:py-16'>
                    <div className='mx-auto w-full max-w-2xl'>
                        ...
                        <div className='mb-6 text-center lg:text-left'>
                            <h1 className='mb-3 font-serif text-3xl leading-tight text-white md:text-4xl lg:text-5xl'>
                                ...
                                <span className='text-2xl md:text-3xl lg:text-4xl'>
                                    Natural Curves. World-Class Safety.
                                </span>
                            </h1>
                            <p className='text-lg leading-relaxed text-stone-300'>
                                Not all BBLs are created equal. Miami is the
                                global capital of the Brazilian Butt Lift—and
                                we&apos;ve refined the art of natural, beautiful
                                curves with an uncompromising focus on safety.
                            </p>
                        </div>
                        ...
                        >
                            <ConsultationForm
                                title='Claim Your Free BBL Consultation'
                                subtitle='Personalized Assessment & 3D Imaging Preview'
                                source={CONTACT_SOURCES.LANDING_PAGE}
                                analyticsFormName='bbl_landing_hero_form'
                                enableAnalytics
                        ...
                        <div className='mt-8 space-y-6'>
                            ...
                            <div className='flex items-start gap-3 rounded-lg border border-white/5 bg-white/5 p-4'>
                                ...
                                <div>
                                    <p className='text-sm leading-relaxed text-stone-300 italic'>
                                        &ldquo;I was so nervous about looking
                                        &apos;fake&apos; or overdone. Dr.
                                        Karlinsky listened to exactly what I
                                        wanted and delivered natural results
                                        that enhanced what I already had.&rdquo;
                                    </p>
                                    <p className='text-gold-400 mt-2 text-xs font-medium'>
                                        — Daniela R., 6 months post-op
                                    </p>
                                </div>
                            </div>
                            ...
                            <p className='text-center text-sm text-stone-500 lg:text-left'>
                                ✓ Free consultation • ✓ 3D imaging preview • ✓
                                Flexible financing
                            </p>
                        </div>
                    </div>
