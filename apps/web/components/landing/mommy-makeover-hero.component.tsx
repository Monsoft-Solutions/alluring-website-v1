/**
 * MommyMakeoverHero Component
 *
 * A conversion-focused hero section targeting post-pregnancy mothers (28-45):
 * - Emotional messaging about reclaiming their body after children
 * - Addresses specific concerns: loose skin, separated muscles, deflated breasts
 * - Strong trust signals for mothers considering multiple procedures
 *
 * Optimized for high-intent searches around mommy makeover procedures.
 */
import {
    Award,
    ShieldCheck,
...
export function MommyMakeoverHero({ id = 'hero' }: MommyMakeoverHeroProps) {
    return (
        <section
            id={id}
                ...
                <div className='animate-fade-in-up flex w-full flex-col justify-center px-6 py-8 delay-200 md:px-12 lg:w-1/2 lg:py-16'>
                    <div className='mx-auto w-full max-w-2xl'>
                        ...
                        <div className='mb-4 hidden items-center gap-2 lg:flex'>
                            <Baby className='text-gold-400 h-4 w-4' />
                            <span className='text-sm font-medium text-stone-400'>
                                For Mothers Ready to Reclaim Their Body
                            </span>
                        </div>
                        ...
                        <div className='mb-6 text-center lg:text-left'>
                            ...
                            <p className='text-lg leading-relaxed text-stone-300'>
                                Your body did something incredible. Pregnancy,
                                nursing, sleepless nights—you gave it all. Now
                                let us help you feel incredible too.
                            </p>
                        </div>
                        ...
                        >
                            <ConsultationForm
                                ...
                                subtitle='Personalized Plan for Your Mommy Makeover'
                                source={CONTACT_SOURCES.LANDING_PAGE}
                                analyticsFormName='mommy_makeover_landing_hero_form'
                                enableAnalytics
                        ...
                        <div className='mt-8 space-y-6'>
                            ...
                            <div className='flex items-start gap-3 rounded-lg border border-white/5 bg-white/5 p-4'>
                                ...
                                <div>
                                    <p className='text-sm leading-relaxed text-stone-300 italic'>
                                        &ldquo;For years, I avoided the beach
                                        and hid my body in loose clothes. After
                                        my mommy makeover at Alluring, I finally
                                        feel like myself again.&rdquo;
                                    </p>
                                    <p className='text-gold-400 mt-2 text-xs font-medium'>
                                        — Jennifer M., Mother of 3
                                    </p>
                                </div>
                            </div>
                            ...
                            <p className='text-center text-sm text-stone-500 lg:text-left'>
                                ✓ Free consultation • ✓ Customized procedure
