...
export default async function GalleryMediaPage({
    ...
    const buildFilterUrl = (newStatus?: string, newType?: string) => {
        const params = new URLSearchParams()
    ...
    const SortIcon = ({ column }: { column: GalleryMediaSortBy }) => {
            ...
            <div className='flex flex-wrap items-center gap-2'>
                ...
                <div className='flex gap-1'>
                    <Button
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl('all', type)}>All</Link>
                    </Button>
                    <Button
                        variant={
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl('published', type)}>
                            Published
                        </Link>
                    </Button>
                    <Button
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl('draft', type)}>Draft</Link>
                    </Button>
                    <Button
                        variant={
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl('archived', type)}>
                            Archived
                        </Link>
                    </Button>
                </div>
                ...
                <div className='flex gap-1'>
                    <Button
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl(status, 'all')}>
                            All Types
                        </Link>
                    </Button>
                    <Button
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl(status, 'image')}>
                    ...
                    <Button
                        ...
                        asChild
                    >
                        <Link href={buildFilterUrl(status, 'video')}>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>
                                    <Link
                                        href={buildSortUrl('displayOrder')}
                                        className='hover:text-foreground inline-flex items-center'
                                    >
                                        Order
