...
export { MedicalClinicSchema } from './medical-clinic/medical-clinic-schema.component'
...
export { ItemListSchema } from './item-list/item-list-schema.component'
export { ProfilePageSchema } from './profile-page/profile-page-schema.component'
export { CollectionPageSchema } from './collection-page/collection-page-schema.component'
export { HowToSchema } from './how-to/how-to-schema.component'
